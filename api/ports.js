// Vercel serverless function for ports
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (BACKEND_URL) {
      console.log('Proxying ports to existing backend:', BACKEND_URL);
      const response = await fetch(`${BACKEND_URL}/api/ports?limit=${limit}`);
